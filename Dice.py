...
class Dice:
    ...
    def __str__(self):
        return ' Last roll: ' + str(self.rolls)
    ...
    def print_count_for_num(self,accumulation):
        self.accumulation = accumulation
        return str(self.accumulation) + ' was rolled ' + str(self.rolls.count(self.accumulation)) + ' times'
...
def main():
    ...
    # BONUS quiz
    # Print accumulation
    print(six_sided.print_count_for_num(3))
